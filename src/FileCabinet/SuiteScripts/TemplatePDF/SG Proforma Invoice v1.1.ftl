...
<#--
    ...
    History:
    v1.1 - 2026-02-11 - Update Bank Instruction to DBS Bank
-->
    ...
    <macrolist>
        <macro id="nlheader">
			...
			<table class="atas">
				<tr>
					...
					<td class="judul border" align="center" width="30%">
						<p><span style="font-size: 14pt;">PROFORMA INVOICE</span></p>
					</td>
					<td width="15%">
						&nbsp;
					</td>
				...
				<tr>
					...
					<td class="border" colspan="2" align="center">
						<p style="text-align: center;"><strong>SO Number</strong><br /><span class="docnumber">${record.tranid}</span></p>
					</td>
				</tr>
			</table>
			<table class="atas">
				<tr>
					...
					<td width="10%">&nbsp;</td>
					<td class="borderless" align="right" width="45%">GST Reg. No.: M2-0072794-X</td>
				</tr>
				<tr>
					<td><br />Sold To:</td>
					<td>&nbsp;</td>
			...
			<table class="subatas" style="margin-top: 15px;">
				<tr><#assign sonumber = record.createdfrom/>
					<td class="border" align="center">
						<p style="text-align: center;"><strong>Order No.</strong><br />${record.custbody_aca_mir_so_number}</p>
					</td>
		...
		<macro id="nlfooter">
				...
				<tr>
					...
					<td rowspan="6" colspan="1">
						...
						<table width="100%">
							...
							<#assign sgd_baseamount = record.subtotal * record.exchangerate />
			...
			<table class="atas" style="border-collapse: collapse; border-style: none; border-width: 1px; margin-right: 0px; margin-left: auto;" border="1">
				<tr>
					<td width="50%"><strong>• INTEREST OF 1.5% PER MONTH WILL BE CHARGED ON OVERDUE ACCOUNT.</strong></td>
					<td style="align: right;"><strong>CLAUSE, GOODS SOLD ARE NOT RETURNABLE</strong></td>
				</tr>
				<tr>
					<td><strong>Banking Instructions (Bank Charges to be borne by Payer):</strong></td>
					<td>&nbsp;</td>
				</tr>
				<tr>
...
<td class="borderkanan" align="left">
	<#if item.custcol_aca_vendor_name_code?has_content>
		${item.item} /<br />${item.custcol_aca_vendor_name_code}
	<#else>
		${item.item}
	</#if>
</td>
...
<p><br />END USER:<br />${record.cseg1}</p>
</td>
