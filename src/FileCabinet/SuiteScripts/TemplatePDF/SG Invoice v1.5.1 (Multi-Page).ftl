...
History:
v1.5.1 - 2026-03-04 - Add tag div style="page-break-inside: avoid;" at table summary to avoid table split into 2 pages when printing in multi-page
v1.5 - 2026-02-19 - Add condition item format for QUANTUM item
v1.4 - 2026-02-11 - Update Banking Instructions
		...
		<table class="atas">
			<tr>
				...
				<#if companyInformation.logoUrl?length != 0>
					<@filecabinet nstype="image" src="${companyInformation.logoUrl}" width="100%" height="100%" />
				</#if>
				</td>
		...
		<table class="subatas" style="margin-top: 15px;">
			<tr>
				...
				<p style="text-align: center;">
					...
					<br />
					${record.custbody_aca_mir_so_number}
				</p>
				</td>
...
<body header="nlheader" header-height="28%" footer="nlfooter" footer-height="0%" padding="0.5in 0.5in 0.5in 0.5in" size="Letter">
		...
		<table class="itemtable" style="width: 100%; margin-top: 10px;" border="1px">
			...
			<#list record.item as item>
				<#if item_index==0>
					<thead>
					<tr>
						<th class="borderkanan borderbawah" align="center" width="5%">
						Qty
						</th>
						<th class="borderkanan borderbawah" align="center" width="20%">
						Item Number
						</th>
						<th class="borderkanan borderbawah" align="center" width="30%">
						Description
						</th>
						<th class="borderkanan borderbawah" align="center" width="18%">
						Unit Price
						</th>
						<th class="borderkanan borderbawah" align="center" width="7%">
						UOM
						</th>
						<th class="borderbawah" align="center" width="20%">
						<p style="text-align: center;">
				...
				<tr>
					<#if record.custbody_aca_hide_zero_qty_print == true>
						<#if item.quantity gt 0>
							<td class="borderkanan" align="right">
							${item.quantity}
							</td>
  ...
  <div style="page-break-inside: avoid;">
	...
	<table class="bawah" style="margin-top: 10px;">
		...
		<tr>
		<td rowspan="6">
		<#if record.custbody_item_commentsg !="">
		...
		${subtotal_after_discount?string["#,##0.00"]}
		</td>
		</tr>
		<tr>
		<td class="borderkiri borderkanan" style="padding-bottom: 5px; padding-top: 5px;">
		...
		<td class="borderbawah" style="padding-bottom: 5px; padding-top: 5px;" align="right">
		${record.taxtotal}
		</td>
		</tr>
		<tr>
		...
		<td class="borderless" style="padding-bottom: 5px; padding-top: 5px;" align="right">
		${nolkan}
		</td>
		</tr>
		<tr>
	...
	<table class="atas" style="border-collapse: collapse; border-style: none; border-width: 1px; margin-right: 0px; margin-left: auto;" border="1">
		...
		<td width="50%">
		<strong>
		• INTEREST OF 1.5% PER MONTH WILL BE CHARGED ON OVERDUE ACCOUNT.
		</strong>
		</td>
		<td style="align: right;">
		<strong>
		CLAUSE, GOODS SOLD ARE NOT RETURNABLE
		</strong>
		</td>
		</tr>
		<tr>
		...
		<strong>
		This Invoice Computer Generated, No Signature Required
		</strong>
		</span>
		</td>
		</tr>
		...
		<td class="borderless" style="height: 1px;" align="center">
		&nbsp;
		</td>
		</tr>
	</table>
